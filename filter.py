...
in the main.py file. Filtering involved resampling, focusing on certain years, and
redefining columns to create 4 identical columns of data
'''
import pandas as pd
...
main():
	...
	#two of them not being sorted by year. These 4 methods remedied the problem.
	...
	#redefine bike_sum column due to some datasets containing pedestrian columns.
	...
	#resample hourly data with NANs into monthly data using timeseries resample.
	...
	#establish columns for lat and lon for each of the 4 points so they
